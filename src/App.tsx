...
function AdminDashboard({ onBack }: { onBack: () => void }) {
  return (
    <main className="flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#0a0a1a] font-sans select-none">
      ...
      >
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500/30 to-blue-500/20 border border-purple-500/30 shadow-[0_0_30px_rgba(124,58,237,0.25)]">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 w-full max-w-[300px]">
          {["Users", "Analytics", "Settings", "Logs"].map((item) => (
            <div key={item} className="rounded-2xl border border-white/[0.08] bg-white/[0.05] p-5 text-center backdrop-blur-xl">
